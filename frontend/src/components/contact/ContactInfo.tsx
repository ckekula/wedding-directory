...
const ContactInfo: React.FC = () => {
  return (
    <div className="flex  bg-white shadow-lg rounded-lg py-8 ">
      <div className="flex gap-12 text-center container w-full justify-center">
        {/* Email Section */}
        <div className="p-6 border w-[300px] border-gray-200 rounded-lg hover:shadow-lg transition-shadow">
